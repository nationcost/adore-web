  ...
  return (
    <>
      ...
      <button
        ...
        className={`fixed bottom-6 right-6 z-50 p-4 rounded-full shadow-[0_0_30px_-5px_rgba(255,255,255,0.2)] transition-all duration-500 hover:scale-110 active:scale-95 ${
          isOpen 
      ...
      {/* Chat Window */}
      <div 
        className={`fixed bottom-24 right-6 z-50 w-[90vw] md:w-96 h-[500px] max-h-[80vh] flex flex-col bg-white/[0.04] backdrop-blur-3xl backdrop-saturate-150 border border-white/10 rounded-[2.5rem] shadow-2xl shadow-black/50 overflow-hidden transition-all duration-500 origin-bottom-right ${
          isOpen 
        ...
        <div className="relative z-10 flex-1 overflow-y-auto p-5 space-y-4 custom-scrollbar">
          {messages.map((msg, idx) => (
            ...
            >
              ...
              <div className={`max-w-[80%] p-3.5 rounded-2xl text-sm leading-relaxed border whitespace-pre-wrap ${
                msg.role === 'user'
