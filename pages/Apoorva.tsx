...
const Apoorva: React.FC = () => {
  ...
  // Song Duration for "Cinnamon Girl" approx 5:02
  const duration = 302; 
  const durationStr = "5:02";
    ...
    >
        ...
        >
            ...
            <div className="relative z-10 mb-8">
                 <p className="text-gray-500 text-sm font-light italic tracking-wide">yapper fr</p>
            </div>

            {/* Action Buttons */}
            <div className="relative z-10 flex gap-3 justify-center w-full px-2 mb-2">
                <a 
                    href="https://discord.com/users/730059646198349924" 
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-full flex items-center justify-center gap-2 p-3.5 bg-white/[0.05] hover:bg-white/[0.1] text-white rounded-2xl transition-all duration-300 group border border-white/5 hover:border-white/20 hover:shadow-lg hover:shadow-white/5"
                >
        ...
        >
            <div className="flex items-center gap-4">
                ...
                <div className="w-14 h-14 rounded-xl bg-gray-900 overflow-hidden relative flex-shrink-0 shadow-lg border border-white/10">
                    <img 
                        src="/media/covers/cinnamon.jpg" 
                        alt="Album" 
                        className="w-full h-full object-cover"
                        onError={(e) => {
                            e.currentTarget.src = 'https://i.scdn.co/image/ab67616d0000b2737c5d4c0f2c4c7a4e8b8b8b8b';
                        }}
                    />
                </div>
                ...
                <div className="flex-1 min-w-0 text-left flex flex-col justify-center gap-1">
                    ...
                    <p className="text-gray-500 text-xs truncate">Lana Del Rey</p>
                </div>
            </div>
